---
name: end-to-end-project-orchestrator
description: Use when the user wants Codex to take a frontend task from idea to implemented, tested, audited, polished, and PR-ready delivery. This skill coordinates other installed skills but must avoid installing unnecessary dependencies.
---
